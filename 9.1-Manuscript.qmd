...
Finally, the NuAge Database and Biobank [@nuage2024] has received approval by the Research Ethics Board of the *Centre intégré universitaire de santé et de services sociaux de l'Estrie---Centre hospitalier universitaire de Sherbrooke*. 
The use of data from the NuAge Database and Biobank for this project is approved by the McGill University Research Ethics Board Office (#22-11-041).
